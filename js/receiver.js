...
castDebugLogger.debug(LOG_RECEIVER_TAG, 'Tonni Test debug');
castDebugLogger.info(LOG_RECEIVER_TAG, 'Tonni Test info');
castDebugLogger.error(LOG_RECEIVER_TAG, 'Tonni Test error');
...
console.log("deviceCapabilities: " + deviceCapabilities);
  ...
  if (deviceCapabilities &&
      ...
      console.log("deviceCapabilities.BLUETOOTH_SUPPORTED: " + deviceCapabilities[cast.framework.system.DeviceCapabilities.BLUETOOTH_SUPPORTED]);
  ...
  if (deviceCapabilities &&
      ...
      console.log("deviceCapabilities.HI_RES_AUDIO_SUPPORTED: " + deviceCapabilities[cast.framework.system.DeviceCapabilities.HI_RES_AUDIO_SUPPORTED]);
  }

  if (deviceCapabilities &&
      deviceCapabilities[cast.framework.system.DeviceCapabilities.IS_DEVICE_REGISTERED]) {
      console.log("deviceCapabilities.IS_DEVICE_REGISTERED: " + deviceCapabilities[cast.framework.system.DeviceCapabilities.IS_DEVICE_REGISTERED]);
  }
  if (deviceCapabilities &&
      deviceCapabilities[cast.framework.system.DeviceCapabilities.IS_GROUP]) {
      console.log("deviceCapabilities.IS_GROUP: " + deviceCapabilities[cast.framework.system.DeviceCapabilities.IS_GROUP]);
  }
  if (deviceCapabilities &&
      deviceCapabilities[cast.framework.system.DeviceCapabilities.IS_DOLBY_ATMOS_SUPPORTED]) {
      console.log("deviceCapabilities.IS_DOLBY_ATMOS_SUPPORTED: " + deviceCapabilities[cast.framework.system.DeviceCapabilities.IS_DOLBY_ATMOS_SUPPORTED]);
  }
  if (deviceCapabilities &&
      deviceCapabilities[cast.framework.system.DeviceCapabilities.CAPABILITY_MULTIZONE_GROUP]) {
      console.log("deviceCapabilities.CAPABILITY_MULTIZONE_GROUP: " + deviceCapabilities[cast.framework.system.DeviceCapabilities.CAPABILITY_MULTIZONE_GROUP]);
  }
